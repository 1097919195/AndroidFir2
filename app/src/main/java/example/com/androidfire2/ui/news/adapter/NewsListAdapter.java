package example.com.androidfire2.ui.news.adapter;
...
import example.com.androidfire2.ui.news.activty.NewsDetailActivity;
import example.com.androidfire2.ui.news.activty.NewsPhotoDetailActivity;
...
public class NewsListAdapter  extends MultiItemRecycleViewAdapter<NewsSummary> {
    ...
    public NewsListAdapter(Context context,final List<NewsSummary> datas)
    {
        ...
        {
            //根据传过来的值决定MultiItemRecycleViewAdapter传给CommonRecycleViewAdapter的布局的方式
            @Override
